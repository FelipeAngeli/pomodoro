...
import 'package:projeto_pomodoro/components/cronometro.dart';
import 'package:projeto_pomodoro/components/entrada_tempo.dart';
    ...
    return Scaffold(
      body: Column(
        crossAxisAlignment: CrossAxisAlignment
            .stretch, //stretch estila, ocupando a linha inteira
        children: [
          const Expanded(
            child: Cronometro(), //estica background
          ),
          Padding(
